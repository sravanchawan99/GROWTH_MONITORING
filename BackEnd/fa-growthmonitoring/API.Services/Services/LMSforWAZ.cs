...
{
    public class LMSforWAZ : ILMSService
    {
        private readonly ILogger<LMSforWAZ> _logger;

        public LMSforWAZ(ILogger<LMSforWAZ> logger)
        {
            _logger = logger;
        }
        ...
        public Task<LMS> ProvideLMSforBoy(Beneficiary child, string filePath)
        {
            ...
            _logger.LogWarning("No LMS found for age {age}", age);
